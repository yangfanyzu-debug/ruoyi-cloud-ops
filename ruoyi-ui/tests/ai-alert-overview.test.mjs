...
assert.match(api, /alert_statistics-api\/api\/stats\/details/)
...
assert.match(page, /getAlertDetails/)
assert.match(page, /detailProcessType/)
assert.match(page, /selectDimension\('system'/)
assert.match(page, /selectDimension\('source'/)
assert.match(page, /告警明细/)
assert.match(page, /row\.dealDescription/)
...
assert.match(chart, /\$emit\('select'/)
